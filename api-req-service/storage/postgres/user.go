...
//NewReqRepo ...
func NewReqRepo(db *sqlx.DB) *reqRepo {
	return &reqRepo{db: db}
}

func (r *reqRepo) GetList(page, limit int64) (*pb.LimitResponse, error) {
	offset := (page - 1) * limit
	var (
...
func (r *reqRepo) GetById(UserId int64) (*pb.Post, error) {
	post := pb.Post{}
...
func (r *reqRepo) DeleteById(UserId int64) (*pb.Ok, error) {
...
func (r *reqRepo) UpdateById(post *pb.Post) (*pb.Ok, error) {
